...
public class Packet26EntityExpOrb extends Packet {
   ...
   public Packet26EntityExpOrb(EntityXPOrb p_i1402_1_) {
      this.field_73533_a = p_i1402_1_.field_70157_k;
      this.field_73531_b = MathHelper.func_76128_c(p_i1402_1_.field_70165_t * 32.0D);
      this.field_73532_c = MathHelper.func_76128_c(p_i1402_1_.field_70163_u * 32.0D);
      this.field_73529_d = MathHelper.func_76128_c(p_i1402_1_.field_70161_v * 32.0D);
      this.field_73530_e = p_i1402_1_.func_70526_d();
   }
