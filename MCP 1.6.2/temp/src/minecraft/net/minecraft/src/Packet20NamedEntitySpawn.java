...
public class Packet20NamedEntitySpawn extends Packet {
   ...
   public Packet20NamedEntitySpawn(EntityPlayer p_i1406_1_) {
      this.field_73516_a = p_i1406_1_.field_70157_k;
      this.field_73514_b = p_i1406_1_.func_70005_c_();
      this.field_73515_c = MathHelper.func_76128_c(p_i1406_1_.field_70165_t * 32.0D);
      this.field_73512_d = MathHelper.func_76128_c(p_i1406_1_.field_70163_u * 32.0D);
      this.field_73513_e = MathHelper.func_76128_c(p_i1406_1_.field_70161_v * 32.0D);
      this.field_73510_f = (byte)((int)(p_i1406_1_.field_70177_z * 256.0F / 360.0F));
      this.field_73511_g = (byte)((int)(p_i1406_1_.field_70125_A * 256.0F / 360.0F));
      ItemStack var2 = p_i1406_1_.field_71071_by.func_70448_g();
      this.field_73518_h = var2 == null?0:var2.field_77993_c;
      this.field_73519_i = p_i1406_1_.func_70096_w();
   }
