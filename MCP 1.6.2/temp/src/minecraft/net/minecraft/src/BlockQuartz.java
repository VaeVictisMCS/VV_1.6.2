...
public class BlockQuartz extends Block {
   ...
   private static final String[] field_94418_b = new String[]{"side", "chiseled", "lines", null, null};
   ...
   public BlockQuartz(int p_i2243_1_) {
      super(p_i2243_1_, Material.field_76246_e);
   ...
   public void func_94332_a(IconRegister p_94332_1_) {
      ...
      for(int var2 = 0; var2 < this.field_94419_c.length; ++var2) {
         if(field_94418_b[var2] == null) {
            ...
            this.field_94419_c[var2] = p_94332_1_.func_94245_a(this.func_111023_E() + "_" + field_94418_b[var2]);
         }
      }

      this.field_94416_cQ = p_94332_1_.func_94245_a(this.func_111023_E() + "_" + "top");
      this.field_94414_cO = p_94332_1_.func_94245_a(this.func_111023_E() + "_" + "chiseled_top");
      this.field_94415_cP = p_94332_1_.func_94245_a(this.func_111023_E() + "_" + "lines_top");
      this.field_94417_cR = p_94332_1_.func_94245_a(this.func_111023_E() + "_" + "bottom");
   }
