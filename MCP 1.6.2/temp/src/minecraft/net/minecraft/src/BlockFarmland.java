...
public class BlockFarmland extends Block {
   ...
   protected BlockFarmland(int p_i2198_1_) {
      super(p_i2198_1_, Material.field_76248_c);
   ...
   public void func_94332_a(IconRegister p_94332_1_) {
      this.field_94441_a = p_94332_1_.func_94245_a(this.func_111023_E() + "_wet");
      this.field_94440_b = p_94332_1_.func_94245_a(this.func_111023_E() + "_dry");
   }
}
