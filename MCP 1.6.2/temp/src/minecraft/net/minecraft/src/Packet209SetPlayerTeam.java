...
public class Packet209SetPlayerTeam extends Packet {
   ...
   public Packet209SetPlayerTeam(ScorePlayerTeam p_i1471_1_, int p_i1471_2_) {
      this.field_96495_a = p_i1471_1_.func_96661_b();
      this.field_96489_f = p_i1471_2_;
      if(p_i1471_2_ == 0 || p_i1471_2_ == 2) {
         this.field_96493_b = p_i1471_1_.func_96669_c();
         this.field_96494_c = p_i1471_1_.func_96668_e();
         this.field_96491_d = p_i1471_1_.func_96663_f();
         this.field_98212_g = p_i1471_1_.func_98299_i();
      }

      if(p_i1471_2_ == 0) {
         this.field_96492_e.addAll(p_i1471_1_.func_96670_d());
      }

   }

   public Packet209SetPlayerTeam(ScorePlayerTeam p_i1472_1_, Collection p_i1472_2_, int p_i1472_3_) {
      if(p_i1472_3_ != 3 && p_i1472_3_ != 4) {
         throw new IllegalArgumentException("Method must be join or leave for player constructor");
      } else if(p_i1472_2_ != null && !p_i1472_2_.isEmpty()) {
         this.field_96489_f = p_i1472_3_;
         this.field_96495_a = p_i1472_1_.func_96661_b();
         this.field_96492_e.addAll(p_i1472_2_);
      } else {
