...
public class Packet24MobSpawn extends Packet {
   ...
   public Packet24MobSpawn(EntityLivingBase p_i1404_1_) {
      this.field_73496_a = p_i1404_1_.field_70157_k;
      this.field_73494_b = (byte)EntityList.func_75619_a(p_i1404_1_);
      this.field_73495_c = p_i1404_1_.field_70168_am.func_75630_a(p_i1404_1_.field_70165_t);
      this.field_73492_d = MathHelper.func_76128_c(p_i1404_1_.field_70163_u * 32.0D);
      this.field_73493_e = p_i1404_1_.field_70168_am.func_75630_a(p_i1404_1_.field_70161_v);
      this.field_73500_i = (byte)((int)(p_i1404_1_.field_70177_z * 256.0F / 360.0F));
      this.field_73497_j = (byte)((int)(p_i1404_1_.field_70125_A * 256.0F / 360.0F));
      this.field_73498_k = (byte)((int)(p_i1404_1_.field_70759_as * 256.0F / 360.0F));
      double var2 = 3.9D;
      double var4 = p_i1404_1_.field_70159_w;
      double var6 = p_i1404_1_.field_70181_x;
      double var8 = p_i1404_1_.field_70179_y;
      if(var4 < -var2) {
         var4 = -var2;
      }
      ...
      this.field_73502_s = p_i1404_1_.func_70096_w();
   }
