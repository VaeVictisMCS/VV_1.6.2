...
import net.minecraft.src.GuiScreenConfirmationType;
import net.minecraft.src.GuiScreenEditOnlineWorld;
import net.minecraft.src.GuiScreenInvite;
import net.minecraft.src.GuiScreenOnlineServers;
import net.minecraft.src.GuiScreenResetWorld;
import net.minecraft.src.GuiScreenSubscription;
import net.minecraft.src.GuiYesNo;
import net.minecraft.src.I18n;
import net.minecraft.src.McoClient;
import net.minecraft.src.McoServer;
import net.minecraft.src.Minecraft;
import net.minecraft.src.SelectionListInvited;
