...
public class BlockEnchantmentTable extends BlockContainer {
   ...
   protected BlockEnchantmentTable(int p_i2196_1_) {
      super(p_i2196_1_, Material.field_76246_e);
   ...
   public void func_94332_a(IconRegister p_94332_1_) {
      this.field_94336_cN = p_94332_1_.func_94245_a(this.func_111023_E() + "_" + "side");
      this.field_94461_a = p_94332_1_.func_94245_a(this.func_111023_E() + "_" + "top");
      this.field_94460_b = p_94332_1_.func_94245_a(this.func_111023_E() + "_" + "bottom");
   }
}
