...
import net.minecraft.src.BlockButtonStone;
import net.minecraft.src.BlockButtonWood;
...
import net.minecraft.src.BlockDropper;
...
import net.minecraft.src.BlockHay;
...
import net.minecraft.src.BlockPoweredOre;
import net.minecraft.src.BlockPressurePlate;
import net.minecraft.src.BlockPressurePlateWeighted;
import net.minecraft.src.BlockPumpkin;
import net.minecraft.src.BlockQuartz;
import net.minecraft.src.BlockRail;
import net.minecraft.src.BlockRailPowered;
...
import net.minecraft.src.ItemSnow;
...
public class Block {
   ...
   protected Block(int p_i2273_1_, Material p_i2273_2_) {
      ...
      if(field_71973_m[p_i2273_1_] != null) {
         throw new IllegalArgumentException("Slot " + p_i2273_1_ + " is already occupied by " + field_71973_m[p_i2273_1_] + " when adding " + this);
      } else {
         this.field_72018_cp = p_i2273_2_;
         field_71973_m[p_i2273_1_] = this;
         this.field_71990_ca = p_i2273_1_;
         this.func_71905_a(0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F);
         field_71970_n[p_i2273_1_] = this.func_71926_d();
         field_71971_o[p_i2273_1_] = this.func_71926_d()?255:0;
         field_71985_p[p_i2273_1_] = !p_i2273_2_.func_76228_b();
      }
   }
   ...
   public void func_94332_a(IconRegister p_94332_1_) {
      this.field_94336_cN = p_94332_1_.func_94245_a(this.func_111023_E());
   }
