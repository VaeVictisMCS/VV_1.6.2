...
public class BlockCauldron extends Block {
   ...
   public BlockCauldron(int p_i2178_1_) {
      super(p_i2178_1_, Material.field_76243_f);
   }
   ...
   public void func_94332_a(IconRegister p_94332_1_) {
      this.field_94378_a = p_94332_1_.func_94245_a(this.func_111023_E() + "_" + "inner");
      this.field_94376_b = p_94332_1_.func_94245_a(this.func_111023_E() + "_top");
      this.field_94377_c = p_94332_1_.func_94245_a(this.func_111023_E() + "_" + "bottom");
      this.field_94336_cN = p_94332_1_.func_94245_a(this.func_111023_E() + "_side");
   }

   public static Icon func_94375_b(String p_94375_0_) {
      return p_94375_0_.equals("inner")?Block.field_72108_bG.field_94378_a:(p_94375_0_.equals("bottom")?Block.field_72108_bG.field_94377_c:null);
   }
   ...
   public int func_94328_b_(World p_94328_1_, int p_94328_2_, int p_94328_3_, int p_94328_4_, int p_94328_5_) {
      int var6 = p_94328_1_.func_72805_g(p_94328_2_, p_94328_3_, p_94328_4_);
