...
public class Packet62LevelSound extends Packet {
   ...
   public Packet62LevelSound(String p_i1439_1_, double p_i1439_2_, double p_i1439_4_, double p_i1439_6_, float p_i1439_8_, float p_i1439_9_) {
      this.field_73579_a = p_i1439_1_;
      this.field_73577_b = (int)(p_i1439_2_ * 8.0D);
      this.field_73578_c = (int)(p_i1439_4_ * 8.0D);
      this.field_73575_d = (int)(p_i1439_6_ * 8.0D);
      this.field_73576_e = p_i1439_8_;
      this.field_73574_f = (int)(p_i1439_9_ * 63.0F);
   ...
   public void func_73267_a(DataInput p_73267_1_) throws IOException {
      this.field_73579_a = func_73282_a(p_73267_1_, 256);
