...
import net.minecraft.src.GuiScreenDisconnectedOnline;
...
import net.minecraft.src.Packet206SetObjective;
import net.minecraft.src.Packet207SetScore;
import net.minecraft.src.Packet208SetDisplayObjective;
import net.minecraft.src.Packet209SetPlayerTeam;
...
import net.minecraft.src.Packet44UpdateAttributesSnapshot;
