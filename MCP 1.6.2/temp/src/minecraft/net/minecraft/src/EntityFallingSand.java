...
public class EntityFallingSand extends Entity {
   ...
   public EntityFallingSand(World p_i1708_1_, double p_i1708_2_, double p_i1708_4_, double p_i1708_6_, int p_i1708_8_, int p_i1708_9_) {
      ...
      this.field_82156_g = 40;
      this.field_82158_h = 2.0F;
      this.field_70287_a = p_i1708_8_;
      this.field_70285_b = p_i1708_9_;
      this.field_70156_m = true;
      this.func_70105_a(0.98F, 0.98F);
      this.field_70129_M = this.field_70131_O / 2.0F;
      this.func_70107_b(p_i1708_2_, p_i1708_4_, p_i1708_6_);
      this.field_70159_w = 0.0D;
      this.field_70181_x = 0.0D;
      this.field_70179_y = 0.0D;
      this.field_70169_q = p_i1708_2_;
      this.field_70167_r = p_i1708_4_;
      this.field_70166_s = p_i1708_6_;
   }
      ...
      if(this.field_82155_f) {
         ...
         if(var2 > 0) {
            ...
            while(var5.hasNext()) {
               ...
               var6.func_70097_a(var4, (float)Math.min(MathHelper.func_76141_d((float)var2 * this.field_82158_h), this.field_82156_g));
            }
