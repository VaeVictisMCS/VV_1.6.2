...
public class Packet28EntityVelocity extends Packet {
   ...
   public Packet28EntityVelocity(Entity p_i1465_1_) {
      this(p_i1465_1_.field_70157_k, p_i1465_1_.field_70159_w, p_i1465_1_.field_70181_x, p_i1465_1_.field_70179_y);
   }

   public Packet28EntityVelocity(int p_i1466_1_, double p_i1466_2_, double p_i1466_4_, double p_i1466_6_) {
      this.field_73390_a = p_i1466_1_;
      double var8 = 3.9D;
      if(p_i1466_2_ < -var8) {
         p_i1466_2_ = -var8;
      }
      ...
      this.field_73388_b = (int)(p_i1466_2_ * 8000.0D);
      this.field_73389_c = (int)(p_i1466_4_ * 8000.0D);
      this.field_73387_d = (int)(p_i1466_6_ * 8000.0D);
   }
