...
public class BlockWorkbench extends Block {
   ...
   protected BlockWorkbench(int p_i2291_1_) {
      super(p_i2291_1_, Material.field_76245_d);
   ...
   public void func_94332_a(IconRegister p_94332_1_) {
      ...
      this.field_94385_a = p_94332_1_.func_94245_a(this.func_111023_E() + "_top");
      this.field_94384_b = p_94332_1_.func_94245_a(this.func_111023_E() + "_front");
   }
