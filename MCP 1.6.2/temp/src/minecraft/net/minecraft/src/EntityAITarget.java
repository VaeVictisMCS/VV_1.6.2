...
import net.minecraft.src.EntityOwnable;
...
public abstract class EntityAITarget extends EntityAIBase {
   ...
   protected boolean func_75296_a(EntityLivingBase p_75296_1_, boolean p_75296_2_) {
      if(p_75296_1_ == null) {
         ...
         if(this.field_75299_d instanceof EntityOwnable && org.apache.commons.lang3.StringUtils.isNotEmpty(((EntityOwnable)this.field_75299_d).func_70905_p())) {
