...
public class Packet17Sleep extends Packet {
   ...
   public Packet17Sleep(Entity p_i1430_1_, int p_i1430_2_, int p_i1430_3_, int p_i1430_4_, int p_i1430_5_) {
      this.field_73622_e = p_i1430_2_;
      this.field_73623_b = p_i1430_3_;
      this.field_73624_c = p_i1430_4_;
      this.field_73621_d = p_i1430_5_;
      this.field_73625_a = p_i1430_1_.field_70157_k;
   }
