...
public class BlockCactus extends Block {
   ...
   protected BlockCactus(int p_i2175_1_) {
      super(p_i2175_1_, Material.field_76268_x);
   ...
   public void func_71869_a(World p_71869_1_, int p_71869_2_, int p_71869_3_, int p_71869_4_, Entity p_71869_5_) {
      p_71869_5_.func_70097_a(DamageSource.field_76367_g, 1.0F);
   }

   public void func_94332_a(IconRegister p_94332_1_) {
      this.field_94336_cN = p_94332_1_.func_94245_a(this.func_111023_E() + "_side");
      this.field_94380_a = p_94332_1_.func_94245_a(this.func_111023_E() + "_top");
      this.field_94379_b = p_94332_1_.func_94245_a(this.func_111023_E() + "_bottom");
   }
}
