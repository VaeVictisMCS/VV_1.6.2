...
public class BlockMushroomCap extends Block {
   ...
   public void func_94332_a(IconRegister p_94332_1_) {
      ...
      for(int var2 = 0; var2 < this.field_94428_c.length; ++var2) {
         this.field_94428_c[var2] = p_94332_1_.func_94245_a(this.func_111023_E() + "_" + field_94429_a[var2]);
      }

      this.field_94427_cP = p_94332_1_.func_94245_a(this.func_111023_E() + "_" + "inside");
      this.field_94426_cO = p_94332_1_.func_94245_a(this.func_111023_E() + "_" + "skin_stem");
   }
