...
public class WorldInfo {
   ...
   public WorldInfo(NBTTagCompound p_i2157_1_) {
      ...
      if(p_i2157_1_.func_74764_b("generatorName")) {
         ...
         if(this.field_76098_b == null) {
            ...
            int var3 = 0;
            if(p_i2157_1_.func_74764_b("generatorVersion")) {
         ...
         if(p_i2157_1_.func_74764_b("generatorOptions")) {
            this.field_82576_c = p_i2157_1_.func_74779_i("generatorOptions");
         }
      }

      this.field_76113_q = EnumGameType.func_77146_a(p_i2157_1_.func_74762_e("GameType"));
      if(p_i2157_1_.func_74764_b("MapFeatures")) {
      ...
      if(p_i2157_1_.func_74764_b("DayTime")) {
