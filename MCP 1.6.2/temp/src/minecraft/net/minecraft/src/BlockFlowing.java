...
public class BlockFlowing extends BlockFluid {
   ...
   public void func_71847_b(World p_71847_1_, int p_71847_2_, int p_71847_3_, int p_71847_4_, Random p_71847_5_) {
      ...
      boolean var8 = true;
      int var9 = this.func_71859_p_(p_71847_1_);
      int var11;
      if(var6 > 0) {
         byte var10 = -100;
         this.field_72214_a = 0;
         int var13 = this.func_72211_e(p_71847_1_, p_71847_2_ - 1, p_71847_3_, p_71847_4_, var10);
         var13 = this.func_72211_e(p_71847_1_, p_71847_2_ + 1, p_71847_3_, p_71847_4_, var13);
         var13 = this.func_72211_e(p_71847_1_, p_71847_2_, p_71847_3_, p_71847_4_ - 1, var13);
         var13 = this.func_72211_e(p_71847_1_, p_71847_2_, p_71847_3_, p_71847_4_ + 1, var13);
         var11 = var13 + var7;
         if(var11 >= 8 || var13 < 0) {
            var11 = -1;
         ...
         if(this.func_72198_f_(p_71847_1_, p_71847_2_, p_71847_3_ + 1, p_71847_4_) >= 0) {
            int var12 = this.func_72198_f_(p_71847_1_, p_71847_2_, p_71847_3_ + 1, p_71847_4_);
            if(var12 >= 8) {
               var11 = var12;
            } else {
               var11 = var12 + 8;
         ...
         if(this.field_72018_cp == Material.field_76256_h && var6 < 8 && var11 < 8 && var11 > var6 && p_71847_5_.nextInt(4) != 0) {
            var9 *= 4;
         }
         ...
         if(var11 == var6) {
            ...
            if(var11 < 0) {
               ...
               p_71847_1_.func_72921_c(p_71847_2_, p_71847_3_, p_71847_4_, var11, 2);
               p_71847_1_.func_72836_a(p_71847_2_, p_71847_3_, p_71847_4_, this.field_71990_ca, var9);
      ...
      if(this.func_72207_p(p_71847_1_, p_71847_2_, p_71847_3_ - 1, p_71847_4_)) {
         ...
         boolean[] var14 = this.func_72206_n(p_71847_1_, p_71847_2_, p_71847_3_, p_71847_4_);
         var11 = var6 + var7;
         if(var6 >= 8) {
            var11 = 1;
         }
         ...
         if(var14[0]) {
            this.func_72210_i(p_71847_1_, p_71847_2_ - 1, p_71847_3_, p_71847_4_, var11);
         }
         ...
         if(var14[2]) {
            this.func_72210_i(p_71847_1_, p_71847_2_, p_71847_3_, p_71847_4_ - 1, var11);
         }
