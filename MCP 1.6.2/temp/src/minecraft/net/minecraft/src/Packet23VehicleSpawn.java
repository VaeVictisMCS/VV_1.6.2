...
public class Packet23VehicleSpawn extends Packet {
   ...
   public Packet23VehicleSpawn(Entity p_i1401_1_, int p_i1401_2_, int p_i1401_3_) {
      this.field_73526_a = p_i1401_1_.field_70157_k;
      this.field_73524_b = MathHelper.func_76128_c(p_i1401_1_.field_70165_t * 32.0D);
      this.field_73525_c = MathHelper.func_76128_c(p_i1401_1_.field_70163_u * 32.0D);
      this.field_73522_d = MathHelper.func_76128_c(p_i1401_1_.field_70161_v * 32.0D);
      this.field_92077_h = MathHelper.func_76141_d(p_i1401_1_.field_70125_A * 256.0F / 360.0F);
      this.field_92078_i = MathHelper.func_76141_d(p_i1401_1_.field_70177_z * 256.0F / 360.0F);
      this.field_73527_h = p_i1401_2_;
      this.field_73528_i = p_i1401_3_;
      if(p_i1401_3_ > 0) {
         double var4 = p_i1401_1_.field_70159_w;
         double var6 = p_i1401_1_.field_70181_x;
         double var8 = p_i1401_1_.field_70179_y;
         double var10 = 3.9D;
         if(var4 < -var10) {
            var4 = -var10;
         }
