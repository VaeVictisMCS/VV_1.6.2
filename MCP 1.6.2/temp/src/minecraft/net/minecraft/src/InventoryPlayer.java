...
import net.minecraft.src.CallableItemName;
   ...
   public void func_70439_a(Item p_70439_1_, int p_70439_2_) {
      if(p_70439_1_ != null) {
         ...
         if(var3 >= 0) {
            ...
            this.field_70462_a[this.field_70461_c] = new ItemStack(Item.field_77698_e[p_70439_1_.field_77779_bT], var4, p_70439_2_);
         } else {
