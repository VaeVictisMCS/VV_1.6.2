...
import net.minecraft.src.GuiScreenMcoWorldTemplateDownloadThread;
import net.minecraft.src.GuiScreenMcoWorldTemplateSelectionList;
import net.minecraft.src.I18n;
import net.minecraft.src.Minecraft;
import net.minecraft.src.ScreenWithCallback;
