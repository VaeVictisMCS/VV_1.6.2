...
public class BlockSandStone extends Block {
   ...
   public BlockSandStone(int p_i2251_1_) {
      super(p_i2251_1_, Material.field_76246_e);
   ...
   public void func_94332_a(IconRegister p_94332_1_) {
      ...
      for(int var2 = 0; var2 < this.field_94406_c.length; ++var2) {
         this.field_94406_c[var2] = p_94332_1_.func_94245_a(this.func_111023_E() + "_" + field_94405_b[var2]);
      }

      this.field_94403_cO = p_94332_1_.func_94245_a(this.func_111023_E() + "_top");
      this.field_94404_cP = p_94332_1_.func_94245_a(this.func_111023_E() + "_bottom");
   }
