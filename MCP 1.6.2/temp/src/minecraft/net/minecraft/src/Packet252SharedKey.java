...
public class Packet252SharedKey extends Packet {
   ...
   public Packet252SharedKey(SecretKey p_i1477_1_, PublicKey p_i1477_2_, byte[] p_i1477_3_) {
      this.field_73306_c = p_i1477_1_;
      this.field_73307_a = CryptManager.func_75894_a(p_i1477_2_, p_i1477_1_.getEncoded());
      this.field_73305_b = CryptManager.func_75894_a(p_i1477_2_, p_i1477_3_);
   }
