...
public class BlockEventData {
   ...
   public BlockEventData(int p_i1966_1_, int p_i1966_2_, int p_i1966_3_, int p_i1966_4_, int p_i1966_5_, int p_i1966_6_) {
      this.field_76927_a = p_i1966_1_;
      this.field_76925_b = p_i1966_2_;
      this.field_76926_c = p_i1966_3_;
      this.field_76924_e = p_i1966_5_;
      this.field_76922_f = p_i1966_6_;
      this.field_76923_d = p_i1966_4_;
   }
