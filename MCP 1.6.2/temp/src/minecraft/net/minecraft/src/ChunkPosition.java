...
public class ChunkPosition {
   ...
   public ChunkPosition(int p_i1967_1_, int p_i1967_2_, int p_i1967_3_) {
      this.field_76930_a = p_i1967_1_;
      this.field_76928_b = p_i1967_2_;
      this.field_76929_c = p_i1967_3_;
   }

   public ChunkPosition(Vec3 p_i1968_1_) {
      this(MathHelper.func_76128_c(p_i1968_1_.field_72450_a), MathHelper.func_76128_c(p_i1968_1_.field_72448_b), MathHelper.func_76128_c(p_i1968_1_.field_72449_c));
   }
