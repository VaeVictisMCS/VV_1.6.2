...
import net.minecraft.src.ContainerRepairINNER1;
import net.minecraft.src.ContainerRepairINNER2;
...
public class ContainerRepair extends Container {
   ...
   private IInventory field_82853_g = new ContainerRepairINNER1(this, "Repair", true, 2);
   ...
   public void func_82848_d() {
      ...
      if(var1 == null) {
         ...
         if(org.apache.commons.lang3.StringUtils.isBlank(this.field_82857_m)) {
   ...
   public void func_82850_a(String p_82850_1_) {
      ...
      if(this.func_75139_a(2).func_75216_d()) {
         ...
         if(org.apache.commons.lang3.StringUtils.isBlank(p_82850_1_)) {
            var2.func_135074_t();
         } else {
            var2.func_82834_c(this.field_82857_m);
         }
      }
