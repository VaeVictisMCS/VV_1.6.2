...
public class Packet41EntityEffect extends Packet {
   ...
   public Packet41EntityEffect(int p_i1487_1_, PotionEffect p_i1487_2_) {
      this.field_73420_a = p_i1487_1_;
      this.field_73418_b = (byte)(p_i1487_2_.func_76456_a() & 255);
      this.field_73419_c = (byte)(p_i1487_2_.func_76458_c() & 255);
      if(p_i1487_2_.func_76459_b() > 32767) {
         this.field_73417_d = 32767;
      } else {
         this.field_73417_d = (short)p_i1487_2_.func_76459_b();
      }
