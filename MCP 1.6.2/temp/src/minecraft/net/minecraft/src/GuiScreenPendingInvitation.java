...
import net.minecraft.src.GuiScreenPendingInvitationINNER1;
import net.minecraft.src.GuiScreenPendingInvitationINNER2;
import net.minecraft.src.GuiScreenPendingInvitationINNER3;
import net.minecraft.src.GuiScreenPendingInvitationList;
